...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default=r"D:\zstudy\Projec_badminton_video_segmetation\Shot-Transition-Detection-main\MoblieVit\data\badminton")

    # 预训练权重路径，如果不想载入就设置为空字符
    parser.add_argument('--weights', type=str, default='MoblieVit/mobilevit_xxs.pt',
